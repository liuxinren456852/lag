...
/*
 ...
 ==================================
 */
SelectionBox::SelectionBox(double firstX, double firstY, double firstZ, double secondX, double secondY, double secondZ, double thirdX, double thirdY, double thirdZ, double fourthX, double fourthY, double fourthZ)
{
...
/*
 ...
 ==================================
 */
SelectionBox::SelectionBox(Point first, Point second, Point third, Point fourth)
{
   points[0] = first;
   points[1] = second;
   points[2] = third;
