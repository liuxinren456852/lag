...
{
   public:
      TwoDeeOverviewWindow(TwoDeeOverview*, AdvancedOptionsWindow*, FileSaver*, Gtk::Window*, Gtk::Window*, const Glib::RefPtr<Gtk::Builder>&, Gtk::EventBox*, ProfileWindow*);
   ...
   private:
      ...
      //Shows quadtree information
      void on_quadtreemenu_activated();

      //Displays coordinates in latlong/UTM
