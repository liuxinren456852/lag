...
{
   public:
      FileOpener(TwoDeeOverview*, Profile*, const Glib::RefPtr<Gtk::Builder>&, AdvancedOptionsWindow*, FileSaver*, int, Gtk::EventBox*, Gtk::EventBox*, TwoDeeOverviewWindow*, AdvancedLoadDialog*);
