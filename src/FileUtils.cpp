...
{
   if(filename.find(".las", filename.length() - 4) != std::string::npos || filename.find(".LAS", filename.length() - 4) != std::string::npos || filename.find(".laz", filename.length() - 4) != std::string::npos || filename.find(".LAZ", filename.length() - 4) != std::string::npos)
   {
      return LAS_FILE;
   } else if(filename.find(".txt", filename.length() - 4) != std::string::npos || filename.find(".TXT", filename.length() - 4) != std::string::npos || filename.find(".csv", filename.length() - 4) != std::string::npos || filename.find(".CSV", filename.length() - 4) != std::string::npos)
   {
      return ASCII_FILE;
   }
